...
def makeInverseIndex(strlist):
    return {subword:{docnum for (docnum, str) in enumerate(strlist) if subword in str.split()} for str in strlist for subword in str.split()}  
...
def orSearch(inverseIndex, query):
    ...
    return {docnum for docnumlist in inverseIndex[word] for word in query for docnum in docnumlist}
    """
