...
representation_dict = {k: (a, b, c) for k in range(base ** 3) for a in digits if
                       (a * base ** 2 <= k) and ((a + 1) * base ** 2 > k) for b in digits if
                       (b * base ** 1 <= (k - (a * base ** 2)) and (b + 1) * base ** 1 > (k - (a * base ** 2))) for c in
                       digits if (c * base ** 0 <= (k - (a * base ** 2) - (b * base ** 1)) and (c + 1) * base ** 0 > (
            k - (a * base ** 2) - (b * base ** 1)))}
